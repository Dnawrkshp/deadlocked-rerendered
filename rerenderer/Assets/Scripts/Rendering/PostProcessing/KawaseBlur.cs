...
public class KawaseBlur : ScriptableRendererFeature
{
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        RenderTargetIdentifier gameRenderRT;

        bool hasGameRenderRT;
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (GameController.UsingGameRender)
            {
                if (!hasGameRenderRT)
                {
                    gameRenderRT = new RenderTargetIdentifier(GameController.GameRender);
                    hasGameRenderRT = true;
                }
            }
            ...
            cmd.Blit(GameController.UsingGameRender ? gameRenderRT : source, tmpRT1, blurMaterial);
            ...
            if (copyToFramebuffer) {
                cmd.Blit(tmpRT1, GameController.UsingGameRender ? gameRenderRT : source, blurMaterial);
            } else {
                cmd.Blit(tmpRT1, tmpRT2, blurMaterial);
